...
//void TestHugeInteger::HugeIntTiming() {
//	std::chrono::system_clock::time_point startTime, endTime;
//	double runTime=0.0;
//	double durationMs=0.0;
//	int n = 10000;
//
//	for (unsigned int numInts=0; numInts < MAX_NUM_INTS; numInts++){
//		HugeInteger huge1(n); //creates a random integer of n digits
//		HugeInteger huge2(n); //creates a random integer of n digits
//		startTime = system_clock::now();
//		for(unsigned int numRun=0; numRun < MAX_RUN; numRun++){
...
//		runTime += durationMs / ((double)MAX_RUN);
//	}
//
//	runTime = runTime/((double)MAX_NUM_INTS);
//	cout << "run time: " << runTime << endl;
//}

void TestHugeInteger::HugeIntTiming() {
	int MAXRUN = 1; // Tune it such that durationMs >= 500
	int MAXNUMINTS = 10; // at least 100
...
//			int c3 = (c1 > c2);
	...
	cout << "Running time for HugeInteger subtract with n="<< n << " is:" << runTime << " ms" << endl;
